    ...
    <section id="navbar">
        <nav class=" navbar navbar-expand-lg navbar-light bg-white bg-body rounded sticky-top ">
          <div class="container">
              <a class="navbar-brand" href="#">
                <img src="../assets/logo/logo belibareng 1-01.png" width="" height="60" alt="">
              </a>
      ...
      <section id="footer">
        <div class="container pt-5 pb-5">
          <div class="row">
            <div class="kontak col-md-4 putih">
            ...
            <div class="tentang-kami col-md-4 putih">
              <div class="d-flex gap-3">
            ...
            <div class="artikel col-md-4 d-flex justify-content-end">
                <div class="card">
                  <img src="../assets/image/artikel1.png" class="card-img-top round" alt="">
                  <div class="isi-card">
                    <h6 class="judul-card ">Bantu Pasarkan Produk UMKM, Mendag Akan Buka Hipermarket di Arab Saudi</h6>
                    <hr>
